...
namespace medicalApp.Migrations
{
    ...
    [Migration("20241028064743_fixCommentMigr")]
    partial class fixCommentMigr
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("medicalApp.Models.CommentDataBaseModel", b =>
                {
                    ...
                    b.Property<Guid>("сonsultationId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("medicalApp.Models.CommentDataBaseModel", b =>
                {
                    ...
                    b.HasOne("medicalApp.Models.ConsultationDataBaseModel", "сonsultation")
                        .WithMany("comments")
                        .HasForeignKey("сonsultationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("author");

                    b.Navigation("сonsultation");
                });
